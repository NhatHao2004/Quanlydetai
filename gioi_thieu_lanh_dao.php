<?php
/**
 * GIỚI THIỆU DÀNH CHO LÃNH ĐẠO
 */

require_once 'bootstrap.php';

$pageTitle = 'Giới thiệu - Dành cho Lãnh đạo';
?>
<!DOCTYPE html>
<html lang="vi">
<head>
    ...
    <!-- Dark Mode Toggle -->
        ...
        <div class="steps-section">
            ...
            <h2 class="text-center mb-5" style="color: #000000; font-weight: 800;">
                Quy trình quản lý đề tài dành cho lãnh đạo
            </h2>
            ...
            <div class="step-item">
                ...
                <div class="step-content">
                    ...
                    <p>Sử dụng tài khoản lãnh đạo được cấp để đăng nhập vào hệ thống quản lý đề tài.</p>
                </div>
            </div>
            ...
            <div class="step-item">
                ...
                <div class="step-content">
                    <h4>Xem tổng quan hệ thống</h4>
                    <p>Truy cập dashboard để xem thống kê tổng quan về số lượng đề tài, giảng viên, sinh viên và tình trạng duyệt đề tài.</p>
                </div>
            </div>
            ...
            <div class="step-item">
                ...
                <div class="step-content">
                    <h4>Duyệt đề tài giảng viên đề xuất</h4>
                    <p>Truy cập danh sách đề tài chờ duyệt, xem chi tiết từng đề tài và quyết định phê duyệt hoặc từ chối kèm lý do.</p>
                </div>
            </div>
            ...
            <div class="step-item">
                ...
                <div class="step-content">
                    <h4>Theo dõi phân công</h4>
                    <p>Kiểm tra danh sách phân công giảng viên - sinh viên, đảm bảo mỗi giảng viên không vượt quá giới hạn sinh viên quy định.</p>
                </div>
            </div>
            ...
            <div class="step-item">
                ...
                <div class="step-content">
                    <h4>Xuất báo cáo</h4>
                    <p>Tạo và xuất các báo cáo thống kê chi tiết về đề tài, phân công và tiến độ thực hiện để phục vụ công tác quản lý.</p>
                </div>
            </div>
            ...
            <div class="step-item">
                ...
                <div class="step-content">
                    <h4>Giám sát toàn bộ quy trình</h4>
                    <p>Theo dõi liên tục hoạt động của hệ thống, đảm bảo quy trình đăng ký và phân công đề tài diễn ra suôn sẻ và đúng quy định.</p>
                </div>
            </div>
        </div>

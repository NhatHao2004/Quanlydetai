<?php
/**
 * GIỚI THIỆU DÀNH CHO GIẢNG VIÊN
 */

require_once 'bootstrap.php';

$pageTitle = 'Giới thiệu - Dành cho Giảng viên';
?>
<!DOCTYPE html>
<html lang="vi">
<head>
    ...
    <!-- Dark Mode Toggle -->
        ...
        <div class="steps-section">
            ...
            <h2 class="text-center mb-5" style="color: #000000; font-weight: 800;">
                Quy trình quản lý đề tài dành cho giảng viên
            </h2>
            ...
            <div class="step-item">
                ...
                <div class="step-content">
                    ...
                    <p>Sử dụng tài khoản giảng viên được cấp để đăng nhập vào hệ thống quản lý đề tài.</p>
                </div>
            </div>
            ...
            <div class="step-item">
                ...
                <div class="step-content">
                    <h4>Tạo đề tài mới</h4>
                    <p>Truy cập menu "Tạo đề tài" để tạo mới đề tài tốt nghiệp. Mỗi giảng viên có thể tạo tối đa 10 đề tài cho mỗi hệ đào tạo.</p>
                </div>
            </div>
            ...
            <div class="step-item">
                ...
                <div class="step-content">
                    <h4>Gửi đề tài chờ duyệt</h4>
                    <p>Sau khi tạo đề tài, gửi đề tài chờ lãnh đạo phê duyệt trước khi sinh viên có thể đăng ký.</p>
                </div>
            </div>
            ...
            <div class="step-item">
                ...
                <div class="step-content">
                    <h4>Quản lý sinh viên đăng ký</h4>
                    <p>Xem danh sách sinh viên đăng ký đề tài của mình, duyệt hoặc từ chối kèm lý do.</p>
                </div>
            </div>
            ...
            <div class="step-item">
                ...
                <div class="step-content">
                    ...
                    <p>Theo dõi danh sách sinh viên đã được phê duyệt và tiến độ thực hiện đề tài.</p>
                </div>
            </div>
            ...
            <div class="step-item">
                ...
                <div class="step-content">
                    <h4>Cập nhật và quản lý đề tài</h4>
                    <p>Cập nhật thông tin đề tài, chỉnh sửa nội dung hoặc xóa đề tài chưa được sinh viên đăng ký.</p>
                </div>
            </div>
        </div>

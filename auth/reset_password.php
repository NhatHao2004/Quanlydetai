...
// Nếu đã đăng nhập, vẫn cho phép đặt lại mật khẩu
// if (isLoggedIn()) {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Lấy token từ GET hoặc hidden field
    ...
    if (empty($password) || empty($confirm_password)) {
        ...
        $error = 'Link khôi phục mật khẩu không hợp lệ';
    } else {
                ...
                <form method="POST" action="?token=<?= htmlspecialchars($token) ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-wrapper">
                            ...
                            <i class="bi bi-eye-slash input-icon" 
                               onclick="togglePassword('passwordField', this)" id="toggleIcon1"></i>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-wrapper">
                            ...
                            <i class="bi bi-eye-slash input-icon" 
                               onclick="togglePassword('confirmPasswordField', this)" id="toggleIcon2"></i>
                        </div>
                    </div>
